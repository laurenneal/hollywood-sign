...
export function drawLot(g, scene, p, opts = {}) {
  ...
  // 28px keeps the caps above the picket actor's countdown plaque (u.y + 34)
  ...
  // Lettered low in the lit window: the benches' backrests cover the cart front below it, and the film office's
  // LAST ROUND sign hangs down to cc.y + 22 at close zoom.
