...
export const SOURCES_URL = 'https://github.com/laurenneal/hollywood-sign/blob/main/SOURCES.md';
...
export const LEGEND = [
  ...
  { district: 'The Boulevard', rows: [
    ...
    { actor: 'The FPF van', signal: 'sign_index',
...
export function renderAboutHtml() {
  ...
  return `
    ...
    <p class="lede">A drawn map of a fictional studio lot. Every crowd, queue, lamp, and weather beat is one public number.
      ...
      Opens on the full lot. District chips (or the phone bar) zoom into stops; pinch or +/− to zoom.</p>
    ...
    <p>Every number traces to a credit. Full table: <a href="${SOURCES_URL}" target="_blank" rel="noopener">SOURCES.md</a>.</p>
    ...
    <p class="keys small">Keys: <kbd>?</kbd> About, <kbd>#</kbd> live numbers, <kbd>Esc</kbd> closes, <kbd>←</kbd> <kbd>→</kbd> timeline
      ...
      Explore toggles pan/pinch; Pause freezes ambient motion. Signal list is in the inspector panel.</p>
  `;
}
