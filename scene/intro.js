...
// scene.js pairs it with an establishing camera: the whole lot shows behind the card, then glides to
// The Gate when the visitor enters. onClose fires on any dismissal so scene.js can run that glide.
  ...
  el.innerHTML = `
    <div class="card" tabindex="-1">
      ...
      <ul>
        ...
        <li>You start on one district. <b>Zoom out or use the district bar</b> to roam the whole lot.</li>
